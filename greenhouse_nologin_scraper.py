...
COMPANIES: dict[str, str] = {
    ...
    "neptuneai":           "neptune.ai",
    "runpod":              "Runpod",
    "sambanovasystems":    "SambaNova Systems",
    "stabilityai":         "Stability AI",
    "turing":              "Turing",
    "hextechnologies":     "Hex Technologies",
    # Robotics / Hard Tech / Aerospace
    ...
    # Cybersecurity (round 2)
    "bugcrowd":            "Bugcrowd",
    "descope":             "Descope",
    "expel":               "Expel",
    "hyperproof":          "Hyperproof",
    "incognia":            "Incognia",
    "sweetsecurity":       "Sweet Security",
    "veza":                "Veza",
    "yubico":              "Yubico",
    # Fintech / Payments (round 2)
    "billcom":             "BILL",
    "billtrust":           "Billtrust",
    "melio":               "Melio",
    "sezzle":              "Sezzle",
    ...
    "veracyte":            "Veracyte",
    # E-commerce / Marketplace / Consumer (round 2)
    "amperity":            "Amperity",
    "brilliantearth":      "Brilliant Earth",
    "glossier":            "Glossier",
    "goop":                "goop",
    "groupon":             "Groupon",
    ...
    # Travel / Mobility (round 2)
    "agoda":               "Agoda",
    "hopskipdrive":        "HopSkipDrive",
    "kayak":               "KAYAK",
    "skyscanner":          "Skyscanner",
    "trivago":             "trivago",
    # Real Estate / PropTech (round 2)
    "homelight":           "HomeLight",
    "roofstock":           "Roofstock",
    "runwise":             "Runwise",
    # Media / Education / Publishing (round 2)
    "beam":                "BEAM",
    "brainpop":            "BrainPOP",
    "ghost":               "Ghost",
    ...
    # Analytics / Data Tooling (round 3)
    "aerospike":           "Aerospike",
    "crossbeam":           "Crossbeam",
    "datagrail":           "DataGrail",
    ...
    # Cloud / Infrastructure / Security (round 3)
    "axiom":               "Axiom",
    "behavox":             "Behavox",
    ...
    # Enterprise SaaS / CRM / Marketing (round 3)
    "benevity":            "Benevity",
    ...
    "prolific":            "Prolific",
    "qualio":              "Qualio",
    # AI / ML / Robotics (round 3)
    "astranis":            "Astranis",
    "chariotdefense":      "Chariot Defense",
    "graphcore":           "Graphcore",
    "instabase":           "Instabase",
    ...
    "stackav":             "Stack AV",
    # Fintech / Payments / Banking (round 3)
    "altruist":            "Altruist",
    ...
    "paystack":            "Paystack",
    "pinwheelapi":         "Pinwheel",
    "prove":               "Prove",
    "ridgeline":           "Ridgeline",
    "spade":               "Spade",
    "stage":               "KKR",
    # Health / Bio / Wellness (round 3)
    "arine":               "Arine",
    "ceribell":            "Ceribell",
    ...
    "oneskin":             "OneSkin",
    "orenda":              "Orenda",
    # Climate / Energy / Materials (round 3)
    "carbon":              "Carbon Inc",
    "carbonchain":         "CarbonChain",
    "overstory":           "Overstory",
    # Commerce / Consumer (round 3)
    "bobbie":              "Bobbie",
    "charterup":           "CharterUP",
    "crisp":               "Crisp",
    "drsquatch":           "Dr. Squatch",
    "extend":              "Extend",
    "feverup":             "FeverUp",
    "fictiv":              "Fictiv",
    "hover":               "Hover",
    ...
    "sothebys":            "Sotheby's",
    "spotter":             "Spotter",
    # Real Estate / PropTech (round 3)
    "scout24":             "Scout24",
    # Media / Education / Publishing (round 3)
    "dscout":              "Dscout",
    "gostudent":           "GoStudent",
    ...
    "quilt":               "Quilt",
    # AI / ML / Robotics (round 3b)
    "thinkingmachines":          "Thinking Machines Lab",
    "manifoldbio":               "Manifold Bio",
    "gatherai":                  "Gather AI",
    "intrinsicrobotics":         "Intrinsic",
    "nerostechnologies":         "Neros Technologies",
    "emergentlabsinc":           "Emergent Labs",
    "focalsystems":              "Focal Systems",
    "symbolica":                 "Symbolica AI",
    "superai":                   "SuperAI",
    "tigergraph":                "TigerGraph",
    # Defense / Aerospace (round 3b)
    "rackner":                   "Rackner",
    "mxd":                       "MXD",
    "formic":                    "Formic",
    # Fintech / Trading / Hedge Funds (round 3b)
    "fiveringsllc":              "Five Rings LLC",
    "alphafmcrolesearlycareers": "Alpha Financial Markets Consulting",
    "aquaticcapitalmanagement":  "Aquatic Capital Management",
    "kronosresearch":            "Kronos Research",
    "engineersgate":             "Engineers Gate",
    "fractalportfolio":          "Fractal Portfolio",
    "alpaca":                    "Alpaca",
    "stashinvest":               "Stash",
    # Cloud / Infrastructure / Security (round 3b)
    "pumpcareers":               "Pump.co",
    "saasgroup":                 "saas.group",
    "userflow":                  "Userflow",
    "vectranetworks":            "Vectra",
    "strivacity":                "Strivacity",
    "bitfocus":                  "Bitfocus",
    # Health / Bio (round 3b)
    "valohealth":                "Valo Health",
    "foresitelabs":              "Foresite Labs",
    "pomelocare":                "Pomelo Care",
    "eucalyptus":                "Eucalyptus",
    "ophelia":                   "Ophelia",
    "iterativehealth":           "Iterative Health",
    "omnicomhealth":             "Omnicom Health",
    "thatch":                    "Thatch",
    # Climate / Energy / Sustainability (round 3b)
    "niraenergy":                "Nira Energy",
    "claros":                    "Claros",
    "newleafenergy":             "New Leaf Energy",
    "cc":                        "Climate Corps",
    "euclidpower":               "Euclid Power",
    "onenergy":                  "ON.energy",
    "augury":                    "Augury",
    "spire":                     "Spire",
    "tomorrow":                  "Tomorrow.io",
    # Enterprise SaaS / B2B (round 3b)
    "openup":                    "OpenUp",
    "thesiscareers":             "Thesis",
    "oosmanagementcorp":         "OOS Management Corp.",
    "remesh":                    "Remesh",
    "humanagency":               "Human Agency",
    "stensul":                   "Stensul",
    "tatari":                    "Tatari",
    "teneo":                     "Teneo",
    ...
    "butterflynetwork":            "Butterflynetwork",
    ...
    "degreed":                     "Degreed",
    "doma":                        "Doma",
    "dynotherapeutics":            "Dynotherapeutics",
    "earnest":                     "Earnest",
    "eclinicalsolutions":          "Eclinicalsolutions",
    "elementbiosciences":          "Elementbiosciences",
    "entradatherapeutics":         "Entradatherapeutics",
    "equityzen":                   "Equityzen",
    "esusu":                       "Esusu",
    "ezra":                        "Ezra",
    "falconx":                     "Falconx",
    ...
    "found":                       "Found",
    "fourkites":                   "Fourkites",
    "freedassociates":             "Freedassociates",
    "freenome":                    "Freenome",
    "generalassembly":             "Generalassembly",
    "generatebiomedicines":        "Generatebiomedicines",
    "gossamerbio":                 "Gossamerbio",
    "grouppmx":                    "Grouppmx",
    "grovecollaborative":          "Grovecollaborative",
    "gspowerpartners":             "GS Power Partners",
    "gumgum":                      "Gumgum",
    "harrys":                      "Harrys",
    "headway":                     "Headway",
    "healthjoy":                   "Healthjoy",
    ...
    "inizio":                      "Inizio",
    "inovalon":                    "Inovalon",
    "internaljobsatlush":          "Internaljobsatlush",
    "intersystems":                "Intersystems",
    "jumptrading":                 "Jumptrading",
    "kaizengaming":                "Kaizengaming",
    "kalshi":                      "Kalshi",
    "karat":                       "Karat",
    "ketryx":                      "Ketryx",
    "kiavi":                       "Kiavi",
    "knowledgecity":               "Knowledgecity",
    "komodohealth":                "Komodohealth",
    "kymeratherapeutics":          "Kymeratherapeutics",
    "latitude":                    "Latitude",
    "layerhealth":                 "Layerhealth",
    "legendcareers":               "Legendcareers",
    "leveltenenergy":              "Leveltenenergy",
    "liberis":                     "Liberis",
    "linushealth":                 "Linushealth",
    "logicgate":                   "Logicgate",
    "logicmonitor":                "Logicmonitor",
    "lunarenergy":                 "Lunarenergy",
    "luxinfusion":                 "Luxinfusion",
    "mark43":                      "Mark43",
    "markforged":                  "Markforged",
    "mill":                        "Mill",
    "misfitsmarket":               "Misfitsmarket",
    "nkarta":                      "Nkarta",
    "oculartherapeutix":           "Oculartherapeutix",
    "odeko":                       "Odeko",
    "ogilvy":                      "Ogilvy",
    "oshihealth":                  "Oshihealth",
    "ownwell":                     "Ownwell",
    "pacaso":                      "Pacaso",
    "pantheon":                    "Pantheon",
    ...
    "plume":                       "Plume",
    "primemedicine":               "Primemedicine",
    "public":                      "Public",
    "qualia":                      "Qualia",
    "rcidoors":                    "RCI Doors",
    "redventures":                 "Redventures",
    "relaytherapeutics":           "Relaytherapeutics",
    "route":                       "Route",
    "rxr":                         "Rxr",
    "seekout":                     "Seekout",
    "sendabiosciences":            "Sail Biomedicines",
    "siliconranch":                "Siliconranch",
    "skillsoft":                   "Skillsoft",
    "skyhawktherapeutics":         "Skyhawktherapeutics",
    "slingshotaerospace":          "Slingshotaerospace",
    "sproutsocial":                "Sproutsocial",
    "stitchfix":                   "Stitchfix",
    "taboola":                     "Taboola",
    "telemed2u":                   "Telemed2u",
    "tesseratherapeutics":         "Tesseratherapeutics",
    "thefarmersdog":               "Thefarmersdog",
    "thetradedesk":                "Thetradedesk",
    "thirdlove":                   "Thirdlove",
    "thirtymadison":               "Remedy Meds",
    "thunes":                      "Thunes",
    "tia":                         "Tia",
    "towerresearchcapital":        "Towerresearchcapital",
    "treasuryprime":               "Treasuryprime",
    "treehousebrewingcompany":     "Treehousebrewingcompany",
    "triplelift":                  "Triplelift",
    "trolley":                     "Trolley",
    "trumid":                      "Trumid",
    "twinhealth":                  "Twinhealth",
    "umojabiopharma":              "Umojabiopharma",
    "vaxcyte":                     "Vaxcyte",
    "vestwell":                    "Vestwell",
    "yext":                        "Yext",
}
