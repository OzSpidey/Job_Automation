...
===========================
Same Boq-scraping strategy as google_scraper.py (US edition), but filtered
to India postings and emailed to the India recipient.
...
def format_date(ts: int | None) -> str:
    """IST wallclock with seconds. e.g. 'May 14, 2026 12:00:00 PM IST'."""
    if not ts:
        return ""
    try:
